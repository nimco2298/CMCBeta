...
public class WordAnalyzer{
   ...
   * "multiple" if it occurs at least twice in the word, not necessarily in    
   * in adjacent positions. 
   * For example, both 'o' and 'l' are multiple in "hollow", but 'h' is   
   * not. 
   * @return the first repeated character, or 0 if none found 
   */ 
  ...
  /**
   * Counts the groups of repeated characters. For example, 
   * "mississippi!!!" has 
